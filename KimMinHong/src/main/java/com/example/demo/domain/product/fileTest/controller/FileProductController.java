package com.example.demo.domain.product.fileTest.controller;

import com.example.demo.domain.product.fileTest.controller.request.RequestFileInfo;
        ...
        try {
            for (MultipartFile multipartFile: fileList) {
                ...
                FileOutputStream writer = new FileOutputStream(
                        "d:/lecture/KHGPM-Frontend/KimMinHong/frontend/src/assets/uploadImgs/" +
